...
public:
	...
	**/
	...
	/**
	\brief Return the current global stop state.

	Determine the current state of the Global Stop input.

	\return true if the Global Stop is engaged.

	**/
	virtual bool GetGlobalStop() = 0;
